...
export function Footer() {
  return (
    <footer className="w-full bg-black border-t border-zinc-800 pt-20 pb-10">
      ...
      <div className="max-w-7xl mx-auto px-6 border-t border-zinc-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-zinc-500">
        <p>© 2026 AegisRoute OS. All rights reserved.</p>
        
        <div className="flex flex-col items-center gap-3">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-zinc-800 bg-zinc-950 text-xs text-zinc-400"> Architected & Founded by <span className="text-white font-medium">Abhijeet Kangane</span></div>
          <div className="flex gap-4">
            <motion.a whileHover={{ scale: 1.2, filter: 'drop-shadow(0px 0px 8px rgba(0, 112, 243, 0.8))' }} href="https://www.linkedin.com/in/abhijeet-kangane/" target="_blank" className="text-gray-400 hover:text-aegis-electric transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
            </motion.a>
            <motion.a whileHover={{ scale: 1.2, filter: 'drop-shadow(0px 0px 8px rgba(255, 255, 255, 0.8))' }} href="https://github.com/abhi666-max" target="_blank" className="text-gray-400 hover:text-white transition-colors">
            ...
            <motion.a whileHover={{ scale: 1.2, filter: 'drop-shadow(0px 0px 8px rgba(255, 255, 255, 0.8))' }} href="https://x.com/abhijeet_037" target="_blank" className="text-gray-400 hover:text-white transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </motion.a>
            <motion.a whileHover={{ scale: 1.2, filter: 'drop-shadow(0px 0px 8px rgba(225, 48, 108, 0.8))' }} href="https://www.instagram.com/abhijeet.037/" target="_blank" className="text-gray-400 hover:text-pink-500 transition-colors">
