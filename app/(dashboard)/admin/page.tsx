  ...
  return (
    ...
    >
      <div className="flex items-center justify-between border-b border-red-500/20 pb-6">
        <div>
          <h1 className="text-4xl font-bold tracking-tighter text-white flex items-center gap-3">
            ...
            GOD MODE <span className="text-red-500 text-sm align-top">OVERRIDE</span>
          </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-zinc-950 border border-red-500/30 rounded-xl p-6 relative overflow-hidden">
          <div className="absolute inset-0 bg-red-500/5" />
          <Database className="w-6 h-6 text-red-500 mb-4 relative z-10" />
          <p className="text-sm text-red-500/70 font-mono tracking-widest uppercase mb-1 relative z-10">Global DB Vectors</p>
          <h3 className="text-3xl font-bold text-red-500 relative z-10">5.2M</h3>
        </div>
      </div>
