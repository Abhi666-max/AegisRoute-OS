  ...
  return (
    <div className="p-8 min-h-screen bg-[#020202] text-white">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h1 className="text-3xl font-bold tracking-tighter text-emerald-500">Server Infrastructure Health</h1>
      </div>
      <p className="text-zinc-500 mb-8">System telemetry linked and operational. Real-time rack visualization.</p>
      
      <div className="flex flex-col gap-4 max-w-4xl border border-zinc-800 rounded-2xl bg-[#050505] p-6 shadow-2xl relative overflow-hidden">
        ...
        {services.map((service, i) => (
          <div key={i} className="flex items-center justify-between border border-zinc-800 bg-zinc-950/80 p-4 rounded-xl relative z-10 group">
            <div className="flex items-center gap-6">
              <div className="w-12 h-12 rounded-lg bg-[#020202] border border-zinc-800 flex items-center justify-center">
